...
import { ArrowLeft, MessageCircle, Phone, Package, Clock, MapPin, CheckCircle2, Truck, Send } from "lucide-react";
...
export default function UserOrderDetail({ orderId }: { orderId: string }) {
    ...
    return (
        <div className="flex-1 space-y-5 px-4 pt-4 pb-6">
            {/* Header */}
            ...
            <div className="grid grid-cols-3 gap-2.5">
                {[
                    ...
                    { icon: Clock, value: order.thoiGianDuKien || "N/A", label: "Estimate Time" },
                    { icon: MapPin, value: order.khoiLuong || "N/A", label: "Package Weight" },
                ].map((item) => (
